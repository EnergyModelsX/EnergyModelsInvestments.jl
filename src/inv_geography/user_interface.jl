...
function GEO.read_data(modeltype::InvestmentModel)
 ...
 transmission = [GEO.Transmission(areas[1], areas[2], [OverheadLine_50MW],Dict("InvestmentModels"=> Dict{GEO.TransmissionMode,EMB.Data}(OverheadLine_50MW => TransInvData(Capex_trans=FixedProfile(500), Trans_max_inst=FixedProfile(50), Trans_max_add=FixedProfile(100), Trans_min_add=FixedProfile(0), Inv_mode=DiscreteInvestment())))),
 GEO.Transmission(areas[1], areas[3], [OverheadLine_50MW],Dict("InvestmentModels"=> Dict{GEO.TransmissionMode,EMB.Data}(OverheadLine_50MW => TransInvData(Capex_trans=FixedProfile(10), Trans_max_inst=FixedProfile(100), Trans_max_add=FixedProfile(100), Trans_min_add=FixedProfile(10), Inv_mode=SemiContinuousInvestment(), Trans_start=0)))),
 GEO.Transmission(areas[2], areas[3], [OverheadLine_50MW],Dict("InvestmentModels"=> Dict{GEO.TransmissionMode,EMB.Data}(OverheadLine_50MW => TransInvData(Capex_trans=FixedProfile(10), Trans_max_inst=FixedProfile(50), Trans_max_add=FixedProfile(100), Trans_min_add=FixedProfile(5), Inv_mode=IntegerInvestment(), Trans_increment=FixedProfile(6), Trans_start=20)))),
 GEO.Transmission(areas[3], areas[4], [OverheadLine_50MW],Dict("InvestmentModels"=> Dict{GEO.TransmissionMode,EMB.Data}(OverheadLine_50MW => TransInvData(Capex_trans=FixedProfile(10), Trans_max_inst=FixedProfile(50), Trans_max_add=FixedProfile(100), Trans_min_add=FixedProfile(1), Inv_mode=ContinuousInvestment(), Trans_start=0)))),
